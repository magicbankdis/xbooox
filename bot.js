...
client.on('message', msg => {
  if (msg.content === 's.ownerbot') {
    msg.reply('**OwnerBot <@444217577439232010>**');
  }
});
...
client.on('message', message => {
       if (message.content.startsWith(prefix + 'vpsbot')) {
...
client.on("message", message => {
 if (message.content === "s.help-admin") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setDescription('👑أوامر الأدمن👑')
	  .addField('❖-|s.msgserver', `📑لخاصية البرودكستات📑`)
  	  .addField('❖-|s.ping', `🎆يقلك كم بنق البوت🎇`)
	  .addField('❖-|s.kick', `🚫لخاصية طرد🚫`)
	  .addField('❖-|s.ban', `⚠عشان تعطي احد حظر من سيرفر للابد⚠`)
                .addField('❖-s.tempban', `🚩عشان تعطي احد حظر من السيرفر بمدة🕞`)
	  .addField('❖-|s.unban', `❌لفك الحظر من احد❎`)
	  .addField('❖-|s.bans', `✅عشان تشوف عدد المبندين في السيرفر✴`)
	  .addField('❖-|s.clear', `❌لخاصية حذف شات❎`)
          .addField('❖-|s.mute', `ℹلاعطاء احد ميوت يعني تجعله ما يقدر يرسل ولا شئ للابد🚫`)
       .addField('❖-|s.tempmute', `✅لاعطاء احد ميوت يعني تجعله ما يقدر يرسل ولا شئ لمدة محددة💠`)
          .addField('❖-|s.unmute', `📄لفك الميوت عن شخص📇`)
          .addField('❖-|s.untempmute', `🔱لفك الميوت عن شخص♍`)
          .addField('❖-|s.report', `⚠عشان تبلغ عن شخص🔞`)
          .addField('❖-|s.setchannel', `♉لأنشاء روم كتابي♎`)
          .addField('❖-|s.setvoice', `♓لأنشاء روم صوتي♏`)
	  .addField('❖-|s.warn', `⚠عشان تعطي احد انظار و لكي يشتغل الامر سوي روم اسمه warns⚠`)
          .addField('❖-|s.autorole toggle', `🚩عشان تفعل الautorole🚩`)
          .addField('❖-|s.autorole set', `👑عشان تحط الرتبة الي اول ما احد يدخل ياخذها👑`)
...
client.on("message", message => {
 if (message.content === "s.help-public") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setDescription('👑أوامر الأعضاء👑')
          .addField('❖-|s.invite', `👑لاضافة البوت الى سيرفرك💯`)
          .addField('❖-|s.profile', `♣لتشوف ملفك الشخصي🌷`)
  	  .addField('❖-|s.bot', `🔱لمعرفة معلومات البوت🅱`)
	  .addField('❖-|s.roles', `👑لمعرفة الرتب الي في السيرفر🔱`)
          .addField('❖-|s.avatar', `🔰يجبلك الافتار حقك يعني صورة حسابك🔰`)
	  .addField('❖-|s.id', `🆔يجبلك الملف الشخصي حقك🆔`)
  	  .addField('❖-|s.channelinfo', `♣ليعطيك معلومات الغرفة🌷`)
  	  .addField('❖-|s.say', `🎆البوت يكرر الكلام الي انت تقوله بدون امبد📝`)
  	  .addField('❖-|s.userinfo', `➿لمعرفة معلوماتك بلكامل🔱`)
          .addField('❖-|s.servers', `➰يجبلك عدد السيرفرات التي البوت داخله➰`)
          .addField('❖-|s.roomsall', `🔰ليقلك اسماء الرومات الموجودة بسيرفر كلها👑`)
	  .addField('❖-|s.embed', `👑البوت يكرر الكلام الي انت تقوله بامبد👑`)
	  .addField('❖-|s.say', `🎆البوت يكرر الكلام الي انت تقوله بدون امبد📝`)
          .addField('❖-|s.support', `🎊سيرفر الدعم حق البوت🎉`)
  	  .addField('❖-|s.vpsbot', `🎆يعرض لك جميع السيرفراا الموجودة بلبوت📝`)
	  .addField('❖-|s.image', `📷يعرض صورة سيرفر⛺`)
          .addField('❖-|s.credits', `👑عشان تشوف الكردتس الخاصة بك👑`)
          .addField('❖-|s.daily', `💲عشان تاخذ الكردتس اليومية الخاصة بك💵`)
          .addField('❖-|s.trans', `💰عشان تعطي لاحد مبلغ من الكردتس الخاصة بك💳`)
          .addField('❖-|s.cal', `📟لاستخدام الالة الحاسبة + للجمع - للطرح * للضرب / للقسمة📝`)
          .addField('❖-|s.owner', `🔰لارسال رسالة لاونر سيرفر🔰`)
          .addField('❖-|s.suggest', `🔱لاقتراح شئ و لازم يكون فيه روم اسمه suggestions👑`)
          .addField('❖-|s.uptime', `🕞عشان تشوف البوت شغال من متى🅱`)
          .addField('❖-|s.botinfo', `🚩عشان تعرف معلومات البوت🚩`)
          .addField('❖-|s.cat', `😍يجبلك صورة قطة🐱`)
  message.author.send({embed});
      message.channel.send(":white_check_mark: | Check Your DM تم الأرسال بلخاص")
 }
});
...
client.on("message", message => {
 if (message.content === "s.help-color") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setDescription('👑أوامر الأعضاء👑')
      .addField('❖-|s.color', `👑لعرض قائمة الألوان💯`)
      .addField('❖-|s.createcolors', `☺لأنشاء 50 لون💯`)
      .addField('❖-|s.setcolor', `😊لتحط ايا لون من هول الالوان اكتب الأمر و الرقم من 1 ل50 انت اختر😉`)
  message.author.send({embed});
      message.channel.send(":white_check_mark: | Check Your DM تم الأرسال بلخاص")
 }
});
 ...
 if (message.content === "s.help-games") {
  const embed = new Discord.RichEmbed()
      ...
      .setDescription('👑اوامر الألعاب👑')
          .addField('❖-|s.صراحه🎮', `لعبة صراحه🎮`)
          .addField('❖-|s.عواصم🎮', `لعبة عواصم🎮`)
	  .addField('❖-|s.عقاب🎮', `لعبة عقاب🎮`)
          .addField('❖-|s.خواطر🎮', `لعبة خواط🎮`)
          .addField('❖-|s.حجرة أو ورقة أو مقص🎮', `لعبة حجرة ورقة مقص🎮`)
          .addField('❖-|s.حب🎮', `لعبة الحب🎮`)
	  .addField('❖-|s.كت تويت🎮', `لعبة كت تويت🎮`)
	  .addField('❖-|s.لو خيروك🎮', `لعبة لو خيروك🎮`)
          .addField('❖-|s.قرعة🎮', `لاستعمال القرعة🎮`)
          .addField('❖-|s.فكك🎮', `لعبة فكك🎮`)
          .addField('❖-|s.لغز🎮', `لعبة لغز🎮`)
          .addField('❖-|s.شقلب🎮', `لعبة شقلب🎮`)
          .addField('❖-|s.كتابة🎮', `لعبة كتابة🎮`)
          .addField('❖-|s.ركب🎮', `لعبة ركب🎮`)
          .addField('❖-|s.رياضيات🎮', `لعبة الرياضيات🎮`)
          .addField('❖-|s.solts🎮', `لعبة الإيموجي🎮`)
  message.author.send({embed});
      message.channel.send(":white_check_mark: | Check Your DM تم الأرسال بلخاص")
 }
});
...
client.on("message", message => {
 if (message.content === "s.support") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('Saz Bot')
      .addField('سيرفر الدعم الفني', `https://discord.gg/WyvAyKu`)
  message.author.send({embed});
      message.channel.send(":white_check_mark: | Check Your DM تم الأرسال بلخاص")
 }
});
...
const Sra7a = [
   ...
   client.on('message', message => {
 if (message.content.startsWith('s.صراحه')) {
     if(!message.channel.guild) return message.reply('** This command only for servers **');
...
const Za7f = [
 ...
 client.on('message', message => {
   if (message.content.startsWith("s.عقاب")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
  var embed = new Discord.RichEmbed()
  .setColor('RANDOM')
   .setThumbnail(message.author.avatarURL)
...
message.channel.sendEmbed(cat);
 ...
 client.on('message', message => {
   if (message.content.startsWith("s.كت تويت")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
  var embed = new Discord.RichEmbed()
  .setColor('RANDOM')
   .setThumbnail(message.author.avatarURL)
...
const secreT = [
 ...
 client.on('message', message => {
   if (message.content.startsWith("s.خواطر")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
  var embed = new Discord.RichEmbed()
  .setColor('RANDOM')
...
const Love = [  "**احبك / عدد قطرات المـــطر والشجر وامواج البحر والنجوم الي تتزاحم مبهورة في جمال القمر**.",  "**ساعزفك وساجعلك لحنا تغني عليه جميع قصائد العشــق**.",  "**احبك موت... لاتسألني ما الدليل ارأيت رصاصه تسأل القتيل؟**.",  "**ربما يبيع الانسان شيئا قد شراه لاكن لا يبيع قلبا قد هواه**.",  "**و ما عجبي موت المحبين في الهوى ........... و لكن بقاء العاشقين عجيب**.",   "**حلفت / لاحشـــد جيوش الحب واحتلك مسكين ربي بلاك بعـــاشق ارهـــابي**.",   "**العيــن تعشق صورتك ... والقلب يجري فيه دمك وكل مااسمع صوتك ...شفايفي تقول احبك**.",   "**ياحظ المكان فيك..ياحظ من هم حواليك ...ياحظ الناس تشوفك ... وانا مشتاق اليك**.",   "**لو كنت دمعة داخل عيوني بغمض عليك وصدقي ما راح افتح...ولو كان الثمن عيوني**.",   "**سهل اموت عشانك لكن الصعب اعيش بدونك سهل احبك لكن صعب انساك**.",   "**أخشى ان انظر لعيناك وأنا فى شوق ولهيب لرؤياك**.",   "**أتمنى ان اكون دمعة تولد بعينيك واعيش على خديك واموت عند شفتيك**.",   "**أحياناً أرى الحياة لا تساوى إبتسامة لكن دائماً إبتسامتك هى كيانى**.",   "**من السهل أن ينسى الانسان نفسه .. لكن من الصعب ان ينسى نفساً سكنت نفسه !**.",   "**نفسى أكون نجمة سماك .. همسة شفاك .. شمعة مساك .. بس تبقى معايا وانا معاك**.",   "**أهنئ قلبى بحبك وصبر عينى فى بعدك وأقول إنك نور عينى يجعل روحى فدى قلبك**.", ]
 ...
 client.on('message', message => {
   if (message.content.startsWith("s.حب")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
  var embed = new Discord.RichEmbed()
  .setColor('RANDOM')
   .setThumbnail(message.author.avatarURL)
...
─════════════ {✯Bot Help✯} ════════════─
   ...
   client.on('message', msg => {
  //Code By : ‡ ♪ ℬℐℓѦℓ✋ ‡#2026
  if(msg.content.startsWith('s.suggest')) {
...
client.on("message", message => {
 if (message.content === "s.help-music") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
...
client.on("message", message => {
 if (message.content === "s.help-welcome") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
        .setDescription('👑أوامر الترحيب👑')
	.addField('❖-|s.wlc 1', `👋يخلي البوت يرسل لك ترحيب بشكل حلو👋`)
	  .addField('❖-|s.wlc 2', `👑يخلي البوت يرسل لك ترحيب بشكل تاني خورافي👑`)
	  .addField('❖-|s.wlc 3', `👋يخلي البوت يرسل لك ترحيب بشكل غير الي فاتوا👋`)
	  .addField('❖-|s.wlc 4', `👑يخلي البوت يرسل لك ترحيب بشكل اخر و خورافي مرة👑`)
          .addField('❖-|s.wlc 5', `👋يخلي البوت يرحب بك بشكل حلو👋`)
          .addField('❖-|s.wlc 6', `👑يخلي البوت يرحب بك بطريقة خورافية👑`)
          .addField('❖-|s.wlc 7', `👋يخلي البوت يرحب بك بطريقة حلوة👋`)
          .addField('❖-|s.wlc 8', `👑يخلي البوت يرحب بك مثل الباقي👑`)
          .addField('❖-|s.wlc 9', `👋يخلي البوت يرحب بك مثل الباقي👋`)
          .addField('❖-|s.wlc 10', `👑يخلي البوت يرحب بك مثل الباقي👑`)
  message.author.send({embed});
      message.channel.send(":white_check_mark: | Check Your DM تم الأرسال بلخاص")
...
client.on('message', message => {
 if (message.content.startsWith("s.wlc 1")) {
                                 var mentionned = message.mentions.users.first();
             var mentionavatar;
               if(mentionned){
...
client.on('message', message => {
 if (message.content.startsWith("s.wlc 2")) {
                                 var mentionned = message.mentions.users.first();
             var mentionavatar;
               if(mentionned){
                   var mentionavatar = mentionned;
...
client.on('message', message => {
 if (message.content.startsWith("s.wlc 3")) {
                                 var mentionned = message.mentions.users.first();
             var mentionavatar;
               if(mentionned){
                   var mentionavatar = mentionned;
...
client.on('message', message => {
 if (message.content.startsWith("s.wlc 4")) {
                                 var mentionned = message.mentions.users.first();
             var mentionavatar;
               if(mentionned){
                   var mentionavatar = mentionned;
...
client.on('message', message => {
 if (message.content.startsWith("s.wlc 5")) {
                                 var mentionned = message.mentions.users.first();
             var mentionavatar;
               if(mentionned){
                   var mentionavatar = mentionned;
...
client.on('message', message => {
 if (message.content.startsWith("s.wlc 6")) {
                                 var mentionned = message.mentions.users.first();
             var mentionavatar;
               if(mentionned){
                   var mentionavatar = mentionned;
...
client.on('message', message => {
 if (message.content.startsWith("s.wlc 7")) {
                                 var mentionned = message.mentions.users.first();
             var mentionavatar;
               if(mentionned){
                   var mentionavatar = mentionned;
...
client.on('message', message => {
 if (message.content.startsWith("s.wlc 8")) {
                                 var mentionned = message.mentions.users.first();
             var mentionavatar;
               if(mentionned){
                   var mentionavatar = mentionned;
...
client.on('message', message => {
 if (message.content.startsWith("s.wlc 9")) {
                                 var mentionned = message.mentions.users.first();
             var mentionavatar;
               if(mentionned){
                   var mentionavatar = mentionned;
...
client.on('message', message => {
 if (message.content.startsWith("s.wlc 10")) {
                                 var mentionned = message.mentions.users.first();
             var mentionavatar;
               if(mentionned){
                   var mentionavatar = mentionned;
...
client.on("message", (message) => {
if (message.content.startsWith("s.setchannel")) {
        let args = message.content.split(" ").slice(1);
...
client.on("message", (message) => {
if (message.content.startsWith("s.setvoice")) {
        let args = message.content.split(" ").slice(1);
...
msg.channel.send(`${item.type}`).then(() => {
  ...
  client.on('message', message => {
if(message.content.startsWith("s.solts")) {
  let slot1 = ['🍏', '🍇', '🍒', '🍍', '🍅', '🍆', '🍑', '🍓'];
  let slot2 = ['🍏', '🍇', '🍒', '🍍', '🍅', '🍆', '🍑', '🍓'];
  let slot3 = ['🍏', '🍇', '🍒', '🍍', '🍅', '🍆', '🍑', '🍓'];
  ...
  client.on('message', message => {
if(message.content.startsWith("s.حجرة")) {
  ...
  client.on('message', message => {
if(message.content.startsWith("s.ورقة")) {
  let slot1 = ['✂ورقة📄', '🗿حجرة🗿', '✂مقص📄'];
  let slots1 = `${slot1[Math.floor(Math.random() * slot1.length)]}`;
  let we;
  if(slots1) {
  ...
  client.on('message', message => {
if(message.content.startsWith("s.مقص")) {
  let slot1 = ['✂ورقة📄', '🗿حجرة🗿', '✂مقص📄'];
  let slots1 = `${slot1[Math.floor(Math.random() * slot1.length)]}`;
  let we;
  if(slots1) {
...
client.on('message', message => {
    let args = message.content.split(' ').slice(1);
if(message.content.split(' ')[0] == 's.tcolor'){
...
client.on("message", message => {
  if (message.author.bot) return;
	if(!message.channel.guild) return;       
if (message.content.startsWith("s.profile")) {
                               let user = message.mentions.users.first();
